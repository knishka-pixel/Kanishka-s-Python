...
class Game:
    def __init__(self):
        ...
        self.speed_increase = 0.2  # How much speed increases per food
    ...
    def draw(self, surface):
        ...
        # Draw length
        length_text = font_medium.render(f"Length: {self.snake.length}", True, PURPLE)
        surface.blit(length_text, (10, 50))

        # Draw speed
        speed_text = font_medium.render(f"Speed: {self.snake.speed:.1f}", True, DARK_GREEN)
...
def draw_title_screen():
    ...
    # Draw instructions - WITHOUT BOXES, just text
    instructions = [
    ...
    # REMOVED: Those two snake boxes and food box
    # Just showing the text instructions cleanly

    pygame.display.update()


# CHANGED: Convert main to async function
async def main():
    game = Game()
    ...
    while True:
        ...
        while in_title_screen:
            ...
            clock.tick(30)
            await asyncio.sleep(0)  # ADDED: Yield control for web
...
# CHANGED: This is the entry point for pygbag
if __name__ == "__main__":
    asyncio.run(main())  # CHANGED: Run as async